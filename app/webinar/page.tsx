...
export const metadata = {
  title:
    "The Blue Ocean Code™ Live Event · Free Event for Consumer Brand Founders",
  description:
    "60-minute live event for founders and leaders of consumer brands. Find the 2-3 words your entire company should run on. Live only. Free. 3 Hot Seats.",
};
