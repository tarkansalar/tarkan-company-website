...
const STEPS: Array<{
  ...
  },
  {
    ...
    lines: [
      "Your team can read it in 10 seconds.",
      "Then they feel it in the first week.",
      "Then they live it - without being told.",
    ],
  },
  {
    num: "3",
            ...
            <div key={s.num} className="bg-card-bg border-l-4 border-neon p-6 lg:p-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  {s.lines && (
                    <div className="border-l-4 border-neon pl-5 mt-5 space-y-1 font-inter text-[16px] leading-[1.6] text-white">
                      {s.lines.map((l) => (
                        <p key={l}>{l}</p>
                      ))}
                    </div>
